...
RSpec.describe Merchant do
  ...
  describe 'Instance Methods' do
    before :each do
      ...
      @user_1_address = @user_1.addresses.create!(street: '123 Main St', city: 'Denver', state: 'CO', zip: 80218)

      @user_2 = User.create!(name: 'Megan', email: 'megan_2@example.com', password: 'securepassword')
      @user_2_address = @user_2.addresses.create!(street: '123 Main St', city: 'Denver', state: 'IA', zip: 80218)

      @order_1 = @user_1.orders.create!(address: @user_1_address)
      ...
      @order_2 = @user_2.orders.create!(status: 1, address: @user_2_address)
      ...
      @order_3 = @user_2.orders.create!(status: 1, address: @user_2_address)
    end
