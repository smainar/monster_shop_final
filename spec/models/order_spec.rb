...
RSpec.describe Order do
  ...
  describe 'class methods' do
    before :each do
      ...
      @order_1 = @user.orders.create!(status: 1, address: @user_address)
      @order_2 = @user.orders.create!(status: 0, address: @user_address)
      @order_3 = @user.orders.create!(status: 3, address: @user_address)
      @order_4 = @user.orders.create!(status: 2, address: @user_address)
    end
