...
RSpec.describe 'Admin Dashboard' do
  describe 'As an Admin' do
    before :each do
      ...
      @m_user_address = @m_user.addresses.create!(street: '123 Main St', city: 'Denver', state: 'CO', zip: 80218, nickname: "home")
      ...
      @order_1 = @m_user.orders.create!(status: "packaged", address: @m_user_address)
      @order_2 = @m_user.orders.create!(status: "pending", address: @m_user_address)
      @order_3 = @m_user.orders.create!(status: "cancelled", address: @m_user_address)
