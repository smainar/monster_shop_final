...
RSpec.describe 'User Show Page' do
  describe 'As an Admin' do
    before :each do
      ...
      @d_user_address = @d_user.addresses.create!(street: '123 Main St', city: 'Denver', state: 'CO', zip: 80218, nickname: "home")
    ...
    it 'I see all info a user sees, without edit ability' do
      ...
      expect(page).to have_content(@d_user_address.street)
